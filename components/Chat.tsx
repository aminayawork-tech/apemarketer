    ...
    <div className="bg-[#FDFAF6] border border-[#D0C4B8] rounded-lg overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-[#111111] border-b border-[#2a2a2a]">
        <div className="flex items-center gap-2">
          <svg className="w-3.5 h-3.5 text-[#E05C0A]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {messages.length === 0 ? (
              <div className="h-full flex flex-col items-center justify-center text-center px-4">
                <div className="w-10 h-10 bg-[#111111] rounded flex items-center justify-center mb-3">
                  <svg className="w-5 h-5 text-[#E05C0A]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
